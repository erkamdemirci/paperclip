...
const levelLabelKeys: Record<string, string> = {
  company: "newGoal.level.company",
  team: "newGoal.level.team",
  agent: "newGoal.level.agent",
  task: "newGoal.level.task",
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("newGoal.headerSubGoal") : t("newGoal.headerLabel")}</span>
          </div>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("common.creating") : newGoalDefaults.parentId ? t("newGoal.createSubGoal") : t("newGoal.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
