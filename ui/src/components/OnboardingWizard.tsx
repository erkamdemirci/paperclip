                      ...
                      {[
                        {
                          ...
                          icon: Sparkles,
                          desc: t("onboarding.localClaudeAgent"),
                          recommended: true
                        },
                        {
                          ...
                          icon: Code,
                          desc: t("onboarding.localCodexAgent"),
                          recommended: true
                        }
                      ].map((opt) => (
                        <button
                        ...
                        {[
                          {
                            ...
                            label: t("onboarding.geminiCli"),
                            icon: Gem,
                            desc: t("onboarding.localGeminiAgent")
                          },
                          {
                            value: "process" as const,
                            label: t("onboarding.process"),
                            icon: Terminal,
                            desc: t("onboarding.runLocalCommand")
                          },
                          {
                            value: "opencode_local" as const,
                            label: t("onboarding.openCode"),
                            icon: OpenCodeLogoIcon,
                            desc: t("onboarding.localMultiProvider")
                          },
                          {
                            value: "pi_local" as const,
                            label: t("onboarding.pi"),
                            icon: Terminal,
                            desc: t("onboarding.localPiAgent")
                          },
                          {
                            value: "cursor" as const,
                            label: t("onboarding.cursor"),
                            icon: MousePointer2,
                            desc: t("onboarding.localCursorAgent")
                          },
                          {
                            value: "openclaw_gateway" as const,
                            label: t("onboarding.openClawGateway"),
                            icon: Bot,
                            desc: t("onboarding.openClawDesc"),
                            comingSoon: true,
                            disabledLabel: t("onboarding.configureWithinApp")
                          }
                        ].map((opt) => (
                          <button
                            key={opt.value}
                    ...
                    <div className="space-y-2 rounded-md border border-border p-3">
                      ...
                      {adapterEnvResult && adapterEnvResult.status === "fail" && (
                        <div className="rounded-md border border-border/70 bg-muted/20 px-2.5 py-2 text-[11px] space-y-1.5">
                          <p className="font-medium">{t("agents.manualDebug")}</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {step === 4 && (
                    <Button size="sm" disabled={loading} onClick={handleLaunch}>
                      ...
                      {loading ? t("common.creating") : t("onboarding.createAndOpenIssue")}
                    </Button>
                  )}
                </div>
              </div>
