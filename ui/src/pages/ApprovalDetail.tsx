...
export function ApprovalDetail() {
  ...
  const revisionMutation = useMutation({
    ...
    onError: (err) => setError(err instanceof Error ? err.message : t("approvals.revisionFailed")),
  });
