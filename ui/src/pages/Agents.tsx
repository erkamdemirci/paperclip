...
export function Agents() {
  ...
  return (
    <div className="space-y-4">
      ...
      {filtered.length > 0 && (
        <p className="text-xs text-muted-foreground">{filtered.length !== 1 ? t("agents.agentCountPlural", { count: filtered.length }) : t("agents.agentCount", { count: filtered.length })}</p>
      )}
