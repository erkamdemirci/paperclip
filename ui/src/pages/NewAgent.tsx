...
export function NewAgent() {
  ...
  const createAgent = useMutation({
    ...
    onError: (error) => {
      setFormError(error instanceof Error ? error.message : t("agents.actionFailed"));
    },
  });
              ...
              >
                {currentReportsTo ? (
                  ...
                  <>
                    ...
                    {isFirstAgent ? t("newAgent.reportsToNA") : t("newAgent.reportsTo")}
                  </>
                )}
              </button>
            </PopoverTrigger>
